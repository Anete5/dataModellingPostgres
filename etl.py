...
def process_song_file(cur, filepath):
    ...
    """
    Processes a song file by opening it and inserting the data in artists and songs tables using previously defined
    queries and data.
    """
    # open song file
...
def process_log_file(cur, filepath):
    ...
    """
    Processes a log file by opening it and inserting the data in time, users and song_plays tables using previously
    defined queries and data.
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def process_data(cur, conn, filepath, func):
    ...
    """
    Processes all the files while showing progress.
    """
...
def main():
    ...
    """
    Connects to the database, processes the queries and all the files.
    """
